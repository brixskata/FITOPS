...
function ReportCard({ children }) { return <section className="overflow-hidden rounded-2xl border border-ink/10 bg-white"><div className="p-5">{children}</div></section> }
...
export function MembershipsReport({ report = {} }) {
  ...
  return <ReportCard><Table headers={['Plan', 'Memberships Sold', 'Revenue', 'Cost', 'Gross Profit']} rows={plans} empty="No membership sales found for the selected period." /></ReportCard>
}
